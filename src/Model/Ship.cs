...
public class Ship
{
    ...
    private bool _isdestroyeddd;
	public bool IsDestroyed {
		get {
            _isdestroyeddd = false;
            if (Hits == Size)
            {
                _isdestroyeddd = true;
            }
            return _isdestroyeddd;
        }
        set { _isdestroyeddd = value; }
	}

    public bool ResetIsDestroyeddd()
    {
        return _isdestroyeddd = false;
    }
