...
public static class GameResources
{
	...
	{
		NewMusic("Background", "TitanForce.mp3");
	}
	...
	private static void FreeSounds()
	{
		...
		foreach (SoundEffect sfx in _Sounds.Values) {
			Audio.FreeSoundEffect(sfx);
		}
	}
	...
	private static void FreeMusic()
	{
		...
		foreach (Music music in _Music.Values) {
